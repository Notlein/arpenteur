...
! function (e, t) {
    ...
    return t = t && t.hasOwnProperty("default") ? t.default : t,
        function (n) {
            ...
            var r = n.parent,
                listener = document.getElementById("overlay-droit"),
            ...
            if (r)
                if (a && s && o) {
                    ...
                    var C = new e.ShaderMaterial({
                        ...
                        D = new e.Mesh(b, C);
                    x.add(D), g && (listener.addEventListener("mouseenter", _), listener.addEventListener("touchstart", _), listener.addEventListener("mouseleave", z), listener.addEventListener("touchend", z)), window.addEventListener("resize", function (t) {
